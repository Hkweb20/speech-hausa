 ...
 */
router.post('/refresh', mongodb_auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.get('/profile', mongodb_auth_1.authenticate, async (req, res) => {
    try {
        const user = await authService.getUserProfile(req.user.id);
        if (!user) {
            return res.status(404).json({
 ...
 * Update user profile
 */
router.put('/profile', mongodb_auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.get('/usage', mongodb_auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.post('/subscription/upgrade', mongodb_auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.post('/subscription/cancel', mongodb_auth_1.authenticate, async (req, res) => {
    try {
