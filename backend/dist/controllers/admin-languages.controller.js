...
async function getLanguages(req, res) {
    try {
        ...
        logger_1.logger.error('Error fetching languages:', error);
        res.status(500).json({
            success: false,
...
async function addLanguage(req, res) {
    try {
        ...
        logger_1.logger.error('Error adding language:', error);
        res.status(500).json({
            success: false,
...
async function updateLanguage(req, res) {
    try {
        ...
        logger_1.logger.info(`Language updated: ${languages[languageIndex].name} (${languages[languageIndex].code})`);
        res.json({
            success: true,
        ...
        logger_1.logger.error('Error updating language:', error);
        res.status(500).json({
            success: false,
...
async function deleteLanguage(req, res) {
    try {
        ...
        logger_1.logger.info(`Language deleted: ${deletedLanguage.name} (${deletedLanguage.code})`);
        res.json({
            success: true,
        ...
        logger_1.logger.error('Error deleting language:', error);
        res.status(500).json({
            success: false,
...
async function getAvailableLanguages(req, res) {
    try {
        ...
        logger_1.logger.error('Error fetching available languages:', error);
        res.status(500).json({
            success: false,
